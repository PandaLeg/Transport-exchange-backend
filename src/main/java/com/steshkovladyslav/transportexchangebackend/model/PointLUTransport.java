...
@Entity
@Table(name = "point_lu_transport")
@Data
@EqualsAndHashCode(of = {"id"})
@ToString(of = {"id"})
public class PointLUTransport implements Serializable {
    @Id
    ...
    public PointLUTransport() {
    }

    public PointLUTransport(String cityFrom, String countryFrom, String cityTo, String countryTo,
                            BigDecimal latFirstPoint, BigDecimal lngFirstPoint, BigDecimal latSecondPoint,
                            BigDecimal lngSecondPoint) {
